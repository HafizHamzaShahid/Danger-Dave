...
l1:			    rep stosw
				...
				shl bx, 1
				add di, 160
				mov cx, [bp + 6]       ;height of the rectangle
...
l3:  			rep stosw          ; for print last line of rectangle
...
escexit:		
		...
		;printing rectangle (Blue horizontal line) here
		mov ax, 25					
		push ax 			; push x-axis
		mov ax, 10						
		push ax; 			push y-axis 
		...
		;printing rectangle (horizontal White line) here
		mov ax, 25					
		push ax 			; push x-axis
		mov ax, 11						
		push ax; 			push y-axis 
       ...
       ;printing rectangle (horizontal White line) here		
		...
		push ax				;length of line on stack
		call printhor 
        ;printing rectangle (last horizontal Blue line) here
        mov ax, 25					
		push ax 			; push x-axis
		mov ax, 18						
		push ax; 			push y-axis 
